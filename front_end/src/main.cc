...
int main()
{
	...
	// get mailbox
	HttpServer::get("/api/{username}/mbox", mailbox_handler);
	// get email
	HttpServer::get("/api/{username}/mbox/{emailId}", email_handler);
	// send an email
	HttpServer::post("/api/user/mailbox/send", sendEMail_handler);
	// respond to an email
	HttpServer::post("/api/user/mailbox/reply", replyEmail_handler);
	// forward an email
	HttpServer::post("/api/user/mailbox/forward", forwardEmail_handler);
	// delete an email
	HttpServer::post("/api/user/mailbox/delete", deleteEmail_handler);
