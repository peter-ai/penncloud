        ...
        if (is_folder(child_path))
        {
            ...
            if (FeUtils::kv_success(folder_content))
            {
                ...
                std::string page =
                    ...
                    "<button type='button' class='btn btn-primary text-center' data-bs-toggle='modal' data-bs-target='#renameFolderModal' style='width:100%;'>"
                    ...
                    "</div>"
                    "<div class='col-1 text-center'>"
                    "<button type='button' class='btn btn-primary text-center' data-bs-toggle='modal' data-bs-target='#moveModal' style='width:100%;'>"
                    ...
                    "</div>"
                    "<div class='col-1 text-center'>"
                    "<button type='button' class='btn btn-primary text-center' data-bs-toggle='modal' data-bs-target='#createFolderModal' style='width:100%;'>"
                    ...
                    blacklist + ";"
                                "blacklist.push($(\"#moving-to\").val().split(\"/\").slice(-2)[0]+\"/\");"
